...
#region 以下是多余的
        ...
        {
            GetRemoteConfig();
            ConfigForm cForm = new ConfigForm(instance);
            AddTabPage("系统配置", cForm);
        }
        ...
        {
            AssignForm assForm = new AssignForm(instance);
