    ...
    public partial class ImportForm : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("确定已经编辑好字段映射了么？" + Environment.NewLine + "本操作会清空原来的" + comboBox2.Text + "资料，请谨慎操作！", "导入提醒", MessageBoxButtons.OKCancel, MessageBoxIcon.Question) == System.Windows.Forms.DialogResult.OK)
            {
                ...
                {
                    WriteLog.CreateLog("配置中心", "ImportForm.button2_Click", "error", ex.ToString());
                }
                finally
                {
        ...
        private void LoadMap(FieldMap<string, string> map)
        {
            if (map != null)
            {
                ...
                while (ie.MoveNext())
                {
                    comboBox3.Items.Add(ie.Current);
                }
            }
            else
            {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (openFileDialog1.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                ...
                List<string> fields;
                data = Common.ReadDataFromExcel(excel, true, out fields);
                if (fields != null)
                {
        ...
        private void comboBox2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                List<string> fields = Common.GetFieldsBySysElement(comboBox2.Text);
                if (fields != null)
                {
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            if (comboBox3.SelectedIndex > -1)
            {
                if (MessageBox.Show("确定要删除该关系么？", "删除提醒", MessageBoxButtons.OKCancel, MessageBoxIcon.Question) == System.Windows.Forms.DialogResult.OK)
                {
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            if (openFileDialog1.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                FieldMap<string, string> map = Common.LoadMapFromLocal<string, string>(openFileDialog1.FileName);
                LoadMap(map);
            }
            openFileDialog1.Dispose();
        }
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            {
                if (Common.SaveMapToLocal<string, string>(map, saveFileDialog1.FileName))
