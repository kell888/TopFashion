        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (comboBox3.SelectedIndex > -1)
            {
                ...
                foreach (object o in listBoxSelecter1.SelectedItems)
                {
                    ...
                    if (u != null)
                    {
                        if (!u.Departments.ContainsDepartment(dep.ID))
                            u.Departments.Add(dep.ID);
                    }
                }
        ...
        private void button13_Click(object sender, EventArgs e)
        {
            if (comboBox12.SelectedIndex > -1)
            {
                ...
                foreach (object o in listBoxSelecter4.SelectedItems)
                {
                    ...
                    if (u != null)
                    {
                        if (!u.Usergroups.ContainsUserGroup(ug.ID))
                            u.Usergroups.Add(ug.ID);
                    }
                }
                MessageBox.Show("添加完毕！");
        ...
        private void comboBox7_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (comboBox7.SelectedIndex > -1)
            {
                ...
                if (role != null)
                {
                    ...
                    {
                        if (role.Permissions.ContainsPermission(p.ID))
                            some.Add(p);
                    }
        ...
        private void comboBox6_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (comboBox6.SelectedIndex > -1)
            {
                ...
                if (dep != null)
                {
                    ...
                    foreach (Role r in owner.CurrentArchitecture.Roles)
                    {
                        if (dep.Roles.ContainsRole(r.ID))
                            some.Add(r);
                    }
                    listBoxSelecter3.SelectSome(some);
                }
        ...
        private void comboBox13_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (comboBox13.SelectedIndex > -1)
            {
                ...
                if (user != null)
                {
                    ...
                    foreach (Role r in owner.CurrentArchitecture.Roles)
                    {
                        if (user.Roles.ContainsRole(r.ID))
                            some.Add(r);
                    }
                    listBoxSelecter3.SelectSome(some);
                }
