...
{
    public partial class PersonalTrainForm : PermissionForm
    {
        public PersonalTrainForm(User user, int selectIndex = 0)
        {
            this.User = user;
            InitializeComponent();
        ...
        {
            if (this.User.ID != this.AdminId && !this.User.GetAllPermissions().ContainsControl("PersonalTrainForm", "私教", "tabControl1"))
                this.tabControl1.SelectedIndex = selectIndex;
        }
        ...
        {
            DataTable dt = Search(textBox8.Text.Trim(), comboBox4.SelectedIndex, textBox9.Text.Trim(), (selectStaffControl2.SelectedStaffs != null && selectStaffControl2.SelectedStaffs.Count > 0) ? selectStaffControl2.SelectedStaffs[0] : null);
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (comboBox1.SelectedIndex > -1)
            {
                ...
                if (personalTrain != null)
                {
                    ...
                    selectMemberControl1.SelectedMembers = new List<Member>() { personalTrain.Member };
