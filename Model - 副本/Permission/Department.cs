...
namespace TopFashion
{
    ...
    public class Department : IArchitecture
    {
        ...
        public Department(int id, string name, List<int> roles)
        {
            this.id = id;
            if (name != null && name.Trim() != "")
                this.name = name;
        ...
        /// <param name="roles"></param>
        /// <param name="parent"></param>
        public Department(int id, string name, List<int> roles, int parent)
        {
            this.id = id;
            if (name != null && name.Trim() != "")
                this.name = name;
        ...
        /// <param name="roles"></param>
        /// <returns></returns>
        public Department CreateSubDepartment(int id, string name, List<int> roles)
        {
